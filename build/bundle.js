var app = (function () {
    ...
    /* src/HowTo.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			div.innerHTML = `<img bp="offset-5@md 4@md 12@sm" src="handWashing.gif" alt="Hand washing instructions" class="svelte-wwxt9"/>`;
    			attr(div, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src/ProgressBar.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div0, "class", "progress-bar svelte-u9qmu7");
    			set_style(div0, "width", /*progress*/ ctx[0] + "%");
    			attr(div1, "bp", "offset-5@md 4@md 12@sm");
    			attr(div1, "class", "progress-container svelte-u9qmu7");
    			attr(div2, "bp", "grid");
    		},
    		m(target, anchor) {
    ...
    /* src/Timer.svelte generated by Svelte v3.35.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(h2, "class", "svelte-1u59l8y");
    			attr(div0, "bp", "grid");
    			attr(button, "bp", "offset-5@md 4@md 12@sm");
    			attr(button, "class", "start-btn svelte-1u59l8y");
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*handleStartClick*/ ctx[3]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [secondsLeft, isTimerRunning, progress, handleStartClick];
    }
    ...
    function create_fragment(ctx) {
    	...
    	let current;
    	timer = new Timer({});
    	timer.$on("time_end", /*playSound*/ ctx[1]);
    	howto = new HowTo({});
    	...
    	return {
    		c() {
    			...
    			h3.innerHTML = `<a href="https://www.who.int/gpsc/clean_hands_protetion/en/">Picture source</a> 
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [audio, playSound, audio_1_binding];
    }
